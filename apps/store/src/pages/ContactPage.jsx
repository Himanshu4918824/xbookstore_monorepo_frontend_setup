...
import { GeneralInquirySlide } from './contact-slides/GeneralInquirySlide';
import { PublicationInquirySlide } from './contact-slides/PublicationInquirySlide';
import { LocationsSlide } from './contact-slides/LocationsSlide';
import ContactTabNavigation from '../components/ui/ContactTabNavigation';
...
function ContactPage() {
  ...
  const slides = [
    <GeneralInquirySlide key="general" />,
    <PublicationInquirySlide key="publication" />,
  ...
  return (
    <>
      <ContactTabNavigation activeSlide={activeSlide} setActiveSlide={setSlide} />
      <Container
        maxWidth={false}
        disableGutters
        onWheel={handleWheel}
